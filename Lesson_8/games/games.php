    ...
    <main>
        <div>
            ...
            <ul>
                ...
                <li>
                    <p>Охота на&nbsp;уток, игра написанная на&nbsp;<abbr title="HyperText Markup Language" lang="en">HTML</abbr>&<abbr title="Cascading Style Sheets" lang="en">CSS</abbr>, разбиралась на&nbsp;вебинаре <a href="https://geekbrains.ru/events/1833">Алексея Кадочникова.</a> На&nbsp;данный момент игра больше демо, не&nbsp;хватает знаний для усложнения логики игры (без использования JS). Будет дорабатываться. На&nbsp;данный момент только три уточки на&nbsp;отстрел.</p>
                </li>
            </ul>
        </div>
    </main>
